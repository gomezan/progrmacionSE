...
#define PERIODO_BASE 1 // 360 Hz
#define NUM_MUERTO 0x10  /// Apagado
#define PERIODO_T1 180   // Divisor a 1 Hz
#define PERIODO_T2 90   // Divisor a 2 Hz
...
{
    // Variables auxliares encargdas del estado de falla a 1 Hz
    static int cont1 = 0;
    static char estado1 = 0;

    // Variables auxliares encargdas del estado de falla a 2 Hz
    static int cont2= 0;
    static char estado2 = 0;
